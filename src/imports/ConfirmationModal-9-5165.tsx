import svgPaths from "./svg-h14nm42hoi";

function Container() {
  return (
    <div className="h-[23.996px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[156.95px] text-[#4a5565] text-[16px] text-center text-nowrap top-[-0.85px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Container1() {
  return (
    <div className="h-[35.989px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[36px] left-[calc(50%+0.13px)] text-[30px] text-center text-neutral-950 top-[0.01px] tracking-[0.3955px] translate-x-[-50%] w-[179px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        $XX.XX
      </p>
    </div>
  );
...
function Container2() {
  return (
    <div className="h-[23.996px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[156.61px] text-[#6a7282] text-[16px] text-center text-nowrap top-[-0.85px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        [PLATFORM]
      </p>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents left-[calc(50%+0.5px)] top-[18px] translate-x-[-50%]">
      <p className="absolute font-['SF_Pro:Medium',sans-serif] font-[510] h-[29px] leading-[22px] left-[calc(50%+0.5px)] text-[24px] text-center text-white top-[92px] tracking-[0.1px] translate-x-[-50%] w-[245px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Accept Trip?
      </p>
...
function Overhead() {
  return (
    <div className="absolute contents left-0 top-0" data-name="Overhead">
      <div className="absolute bg-[#4db3a1] h-[138px] left-0 rounded-tl-[15px] rounded-tr-[15px] top-0 w-[342px]" />
      <Group />
    </div>
  );
}
...
function NavMessage() {
  return (
    <div className="absolute bg-gray-100 box-border content-stretch flex gap-[11.993px] h-[73.389px] items-start left-[16px] pb-[0.717px] pl-[16.707px] pr-[0.717px] pt-[16.707px] rounded-[14px] top-[268px] w-[312.747px]" data-name="Nav Message">
      ...
      <AlertIcon />
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-black tracking-[-0.1504px] w-[217px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ApplyButton() {
  return (
    <div className="absolute bg-[#4db3a1] h-[56px] left-[calc(50%+1px)] rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[calc(50%+143.5px)] translate-x-[-50%] translate-y-[-50%] w-[312px]" data-name="Apply Button">
