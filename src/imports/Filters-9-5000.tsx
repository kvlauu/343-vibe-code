import svgPaths from "./svg-kfxhmsshqr";
  ...
  return (
    <div className="h-[31.991px] relative shrink-0 w-[101.472px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[31.991px] relative w-[101.472px]">
        <p className="absolute font-['SF_Pro:Medium',sans-serif] font-[510] leading-[32px] left-0 text-[24px] text-neutral-950 text-nowrap top-[-0.57px] tracking-[0.0703px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
          Filter By...
        </p>
      </div>
    </div>
...
function DeliveryButton() {
  return (
    <div className="bg-[#4db3a1] h-[34px] relative rounded-[9px] shrink-0 w-[166px]" data-name="Delivery Button">
      <div aria-hidden="true" className="absolute border-[#4db3a1] border-[1.433px] border-solid inset-0 pointer-events-none rounded-[9px]" />
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-1/2 text-[16px] text-center text-nowrap text-white top-[calc(50%-12px)] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Uber
      </p>
    </div>
  );
...
function DeliveryButton1() {
  return (
    <div className="bg-gray-100 h-[34px] relative rounded-[9px] shrink-0 w-[166px]" data-name="Delivery Button">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-1/2 text-[16px] text-black text-center text-nowrap top-[calc(50%-12px)] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Lyft
      </p>
...
function DeliveryButton2() {
  return (
    <div className="bg-gray-100 h-[34px] relative rounded-[9px] shrink-0 w-[166px]" data-name="Delivery Button">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[calc(50%+0.5px)] text-[16px] text-black text-center text-nowrap top-[calc(50%-12px)] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        DoorDash
      </p>
    </div>
  );
...
function DeliveryButton3() {
  return (
    <div className="bg-[#4db3a1] h-[34px] relative rounded-[9px] shrink-0 w-[166px]" data-name="Delivery Button">
      <div aria-hidden="true" className="absolute border-[#4db3a1] border-[1.433px] border-solid inset-0 pointer-events-none rounded-[9px]" />
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[calc(50%+0.5px)] text-[16px] text-center text-nowrap text-white top-[calc(50%-12px)] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        SkipTheDishes
      </p>
    </div>
  );
...
function RideDeliveryButtons() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start justify-center relative shrink-0 w-full" data-name="Ride/Delivery Buttons">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#364153] text-[14px] text-nowrap tracking-[-0.1504px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Platforms
      </p>
      <Frame />
      <Frame1 />
...
function DeliveryButton4() {
  return (
    <div className="bg-[#4db3a1] h-[50.848px] relative rounded-[14px] shrink-0 w-[166.362px]" data-name="Delivery Button">
      <div aria-hidden="true" className="absolute border-[#4db3a1] border-[1.433px] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[83.62px] text-[16px] text-center text-nowrap text-white top-[12.58px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Ride
      </p>
    </div>
  );
  ...
  return (
    <div className="h-[19.988px] relative shrink-0 w-full" data-name="Radius">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex h-[19.988px] items-center justify-between leading-[20px] relative text-[14px] tracking-[-0.1504px] w-full">
          <p className="font-['SF_Pro:Regular',sans-serif] font-normal relative shrink-0 text-[#364153] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
            Radius from current location
          </p>
          <p className="font-['SF_Pro:Medium',sans-serif] font-[510] relative shrink-0 text-neutral-950 text-right w-[42px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            XX km
          </p>
        </div>
      </div>
...
function Ranges() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex font-['SF_Pro:Regular',sans-serif] font-normal h-[16.001px] items-start justify-between leading-[16px] ml-0 mt-[24.69px] relative text-[#6a7282] text-[12px] text-nowrap w-[344.727px] whitespace-pre" data-name="Ranges">
      <p className="relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        XX km
      </p>
      <p className="relative shrink-0 text-right" style={{ fontVariationSettings: "'wdth' 100" }}>
        XX km
      </p>
    </div>
  );
    ...
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Range Slider (Radius)">
      ...
      <div className="[grid-area:1_/_1] ml-[75.59px] mt-0 relative size-[16px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
          <circle cx="8" cy="8" fill="var(--fill-0, #4DB3A1)" id="Ellipse 25" r="8" />
        </svg>
      </div>
      <Ranges />
    </div>
...
function ApplyButton() {
  return (
    <div className="bg-[#4db3a1] h-[55.976px] relative rounded-[14px] shrink-0 w-full" data-name="Apply Button">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[172.97px] text-[16px] text-center text-nowrap text-white top-[15.14px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Apply Filters
      </p>
    </div>
  );
...
function ResetButton() {
  return (
    <div className="bg-gray-100 h-[55.976px] relative rounded-[14px] shrink-0 w-full" data-name="Reset Button">
      <p className="absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[24px] left-[172.78px] text-[#101828] text-[16px] text-center text-nowrap top-[15.14px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Reset to Default
      </p>
    </div>
  );
