import svgPaths from "./svg-ohha1tkojd";
import imgLiveIcon from "figma:asset/d04f0bbbcc17f5a1ec764756a55c340fe65cc030.png";

function Icon() {
  return (
    <div className="absolute left-[147.65px] size-[63.994px] top-[47.99px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 64">
        <g id="Icon">
          <path d={svgPaths.p3fe26e00} id="Vector" stroke="var(--stroke-0, #D1D5DC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5.33282" />
          <path d={svgPaths.pad5cd00} id="Vector_2" stroke="var(--stroke-0, #D1D5DC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5.33282" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="absolute h-[23.996px] left-0 top-[127.98px] w-[359.306px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[180.31px] not-italic text-[#101828] text-[16px] text-center text-nowrap top-[-0.85px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre">No offers match your filters</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[19.988px] left-0 top-[159.97px] w-[359.306px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[180.42px] not-italic text-[#6a7282] text-[14px] text-center text-nowrap top-[0.43px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">Try adjusting your filters to see more offers</p>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="absolute left-[24px] size-[15.99px] top-[15.99px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M6.66253 3.33126H1.99876" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M7.99503 12.6588H1.99876" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M9.32754 1.99876V4.66377" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M10.66 11.3263V13.9913" id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M13.9913 7.99503H7.99503" id="Vector_5" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M13.9913 12.6588H10.66" id="Vector_6" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M13.9913 3.33126H9.32754" id="Vector_7" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M5.33002 6.66253V9.32754" id="Vector_8" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
          <path d="M5.33002 7.99503H1.99876" id="Vector_9" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33251" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-black h-[47.981px] left-[96.69px] rounded-[14px] top-[203.95px] w-[165.914px]" data-name="Button">
      <Icon1 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[95.48px] not-italic text-[16px] text-center text-nowrap text-white top-[11.14px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre">Adjust Filters</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute bg-white border-[0.717px] border-gray-200 border-solid h-[301.359px] left-[15.99px] rounded-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] top-[176.62px] w-[360.74px]" data-name="Container">
      <Icon />
      <Paragraph />
      <Paragraph1 />
      <Button />
...
function LiveOfferHeader() {
  return (
    <div className="absolute content-stretch flex gap-[13px] items-center left-[22px] top-[66px]" data-name="Live Offer Header">
...
function Icons() {
  return (
    <div className="absolute content-stretch flex gap-[11px] items-center left-[284px] top-[70px]" data-name="Icons">
      <RefreshIcon />
      <SortIcon />
      <FilterIcon />
    </div>
...
export default function NoOffersAvailable() {
  return (
    <div className="bg-white relative size-full" data-name="No offers available 2">
      <TopBar1 />
      <Container />
      <BottomNavBar />
    </div>
