...
export function NavigationHeader({ streetName, distance, direction, onBack }: NavigationHeaderProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="bg-[#4db3a1] rounded-b-[25px] pb-10 pt-4 px-6">
        ...
        {/* Next turn indicator */}
        <div className="flex items-center gap-3 mt-4 ml-[67px]">
      ...
      {/* Extended curve */}
      <div className="absolute left-0 bottom-[-31px] w-[130px] h-[60px] bg-[#345a53] rounded-[25px]" />
      <div className="absolute left-0 bottom-[-18px] w-[26px] h-[31px] bg-[#4db3a1]" />
    </div>
  );
}
